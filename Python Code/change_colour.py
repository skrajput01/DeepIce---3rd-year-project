...
with open("prediction_results_5760mols.dat", "r") as file: # output file of DeepIce--predict is taken as input 
    i = 0
    for line in file:
        i+=1
...
with open("5760_Basalz_oxy.xyz", "r") as file: # open structure file
    line_list = []
    ss = file.readlines()
    newss = [ss[0], ss[1]]
...
with open("5760_Basal_i=25.xyz", "w") as file:
