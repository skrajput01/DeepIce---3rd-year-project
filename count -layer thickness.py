...
# colors= ["#e64a50", "#ddc7c9","#3f60f5", "#030838", "#ddc7c9","#fc9802","#f4dc76","#d75a13", "#570f08"]
# #multiplier = [1.15**i for i in range(100)]
# for value, temperature, color in zip(flut_molecules_XIc, temperature_XIc, colors):
#     ax[1].grid(linestyle="--", c="#ddc7c9")
#     ax[1].plot(time, np.array(value[:401]), '-', c=color, label=f"${temperature}K$")
#     ax[1].set_xlabel("Time ($ns$)")
#     #ax[1].set_ylabel("Water Molecules")
# print(molecules_XIc)
# #locs, labels = plt.yticks()
# #labels, locations = plt.yticks()
# ax[1].set_yticks(np.arange(0, 950, 100))
# #ax[0].set_title("XIc")
# #ax[3].legend()
# #plt.show()

# colors= ["#e64a50", "#ddc7c9","#3f60f5", "#030838","#fc9802","#f4dc76","#d75a13", "#570f08"]
# for value, temperature, color in zip(flut_molecules_YPrism, temperature_YPrism, colors):
#     ax[3].grid(linestyle="--", c="#ddc7c9")
#     ax[3].plot(time, value[:401], '-', c = color)
#     ax[3].set_xlabel("Time ($ns$)")
#     #ax[3].set_ylabel("Water Molecules")
#     ax[3].set_yticks(np.arange(0, 950, 100))
# #ax[1].set_title("YPrism")
# #ax[4].legend()
# #plt.show()

# for value, temperature, color in zip(flut_molecules_ZBasal, temperature_ZBasal, colors):
#     ax[5].grid(linestyle="--", c="#ddc7c9")
#     ax[5].plot(time, value[:401], '-',c = color)
#     ax[5].set_xlabel("Time ($ns$)")
#     #ax[5].set_ylabel("Water Molecules")
#     ax[5].set_yticks(np.arange(0, 950, 100))
# #ax[2].set_title("ZBasal")
